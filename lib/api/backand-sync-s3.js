...
function dist(folder, appName, service, destFolder, zipFile){
  ...
  var reporterOptions = {};
  if (service == 'hosting') {
    successMessage = "The code was deployed and now available in: https://" + info.bucket + "/" + dir;
  }
  else {
    reporterOptions = {
      states: []
    };
    successMessage = "The code was deployed and available";
  }
  ...
  // exclude files with special characters in name
      ...
      .pipe(awspublish.reporter(reporterOptions))
      .pipe(notify({
