...
module.exports = function () {
  ...
  switch (term) {
    ...
    case 'signin':
    case 's':
      console.log('Usage: ' + 'backand (s)ignin'.blue);
      console.log('Signin to Backand Cloud Services');
      break;
    case 'signout':
    case 'o':
      console.log('Usage: ' + 'backand sign(o)ut'.blue);
      console.log('Signout from Backand Cloud Services');
      break;
    case 'get':
    case 'g':
    ...
    case 'ae':
      ...
      console.log('Delete your node.js action from Backand Cloud Services');
      break;
    default:
      ...
      console.log('   signin        ' + 's      ' + '                ' + 'Signs into Backand Cloud Services');
      console.log('   signout       ' + 'o      ' + '                ' + 'Signs out from Backand Cloud Services');
      ...
      console.log('   action delete ' + 'ae     ' + '                ' + 'Delete your node.js action from Backand Cloud Services');
