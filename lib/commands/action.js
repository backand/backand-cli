...
var innerActions = {
    ...
    'status': require('./action/action-status'),
...
module.exports = function (options) {
    ...
    // see json upper -> it should be second command -> init, deploy, status
    ...
    innerActions[command](appName, object, actionName, userToken, masterToken);
