...
var updateActionInBackand = function (appName, object, action, fileName, userToken, masterToken, callback) {
...
module.exports = function (appName, objectName, actionName, userToken, masterToken, folder) {
    ...
    gulp.task('updateActionInBackand', ['dist'], function (callback) {
        updateActionInBackand(appName, objectName, actionName, zipFile, userToken, masterToken, callback);
    });
